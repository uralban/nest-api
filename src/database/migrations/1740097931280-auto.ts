...
export class Auto1740097931280 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "notification" ADD CONSTRAINT "FK_ec0adb47d5237aef2018e3a9745" FOREIGN KEY ("companyId") REFERENCES "company"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "notification" DROP CONSTRAINT "FK_ec0adb47d5237aef2018e3a9745"`,
    );
    await queryRunner.query(
